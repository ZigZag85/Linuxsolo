...
import linuxsolo.modules.sql.notes_sql as sql
from linuxsolo import dispatcher, LOGGER, OWNER_ID, SUDO_USERS, spamfilters, TEMPORARY_DATA
from linuxsolo.__main__ import DATA_IMPORT
from linuxsolo.modules.helper_funcs.chat_status import user_admin
from linuxsolo.modules.helper_funcs.misc import build_keyboard, revert_buttons
from linuxsolo.modules.helper_funcs.msg_types import get_note_type
from linuxsolo.modules.rules import get_rules
from linuxsolo.modules.helper_funcs.string_handling import button_markdown_parser, make_time

# SQL
import linuxsolo.modules.sql.antiflood_sql as antifloodsql
import linuxsolo.modules.sql.blacklist_sql as blacklistsql
import linuxsolo.modules.sql.blsticker_sql as blackliststksql
from linuxsolo.modules.sql import disable_sql as disabledsql
from linuxsolo.modules.sql import cust_filters_sql as filtersql
from linuxsolo.modules.sql import languages_sql as langsql
import linuxsolo.modules.sql.locks_sql as locksql
from linuxsolo.modules.locks import LOCK_TYPES, RESTRICTION_TYPES
from linuxsolo.modules.sql import notes_sql as notesql
from linuxsolo.modules.sql import reporting_sql as reportsql
import linuxsolo.modules.sql.rules_sql as rulessql
from linuxsolo.modules.sql import warns_sql as warnssql
import linuxsolo.modules.sql.welcome_sql as welcsql

from linuxsolo.modules.connection import connected

from linuxsolo.modules.helper_funcs.msg_types import Types
from linuxsolo.modules.languages import tl
...
def import_data(bot: Bot, update):
	...
	if msg.reply_to_message and msg.reply_to_message.document:
		...
		try:
			# If backup is from linuxsolo
			if data.get('bot_base') == "linuxsolo":
				imp_antiflood = False
				imp_blacklist = False
			...
			send_message(update.effective_message, tl(update.effective_message, "Telah terjadi kesalahan dalam import backup linuxsolo!\nGabung ke [Grup support](https://t.me/joinchat/Fykz0VTMpqZvlkb8S0JevQ) kami untuk melaporkan dan mengatasi masalah ini!\n\nTerima kasih"), parse_mode="markdown")
			LOGGER.exception("An error when importing from linuxsolo base!")
			return
...
def export_data(bot: Bot, update: Update, chat_data):
	...
	f = open("{}-linuxsolo.backup".format(chat_id), "w")
	...
	try:
		...
		pass
	os.remove("{}-linuxsolo.backup".format(chat_id)) # Cleaning file
