...
from linuxsolo import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL, spamfilters
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from linuxsolo.modules import ALL_MODULES
from linuxsolo.modules.languages import tl
from linuxsolo.modules.helper_funcs.chat_status import is_user_admin
from linuxsolo.modules.helper_funcs.misc import paginate_modules
from linuxsolo.modules.sql import languages_sql as langsql

from linuxsolo.modules.connection import connect_button
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("linuxsolo.modules." + module_name)
