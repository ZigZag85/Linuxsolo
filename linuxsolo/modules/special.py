...
from linuxsolo import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, WHITELIST_USERS, BAN_STICKER, API_WEATHER, spamfilters
from linuxsolo.__main__ import STATS, USER_INFO
from linuxsolo.modules.disable import DisableAbleCommandHandler, DisableAbleRegexHandler
...
__mod_name__ = "💖 Exclusive linuxsolo 💖"
