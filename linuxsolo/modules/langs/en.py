...
# languages
	...
	"language_help": """Not every group speaks indonesian; some groups would rather have linuxsolo respond in their own language.

This is where translations come in; you can change most of linuxsolo's replies to be in the language of your choice!
...
Join our group [linuxsolo Official Support](https://t.me/linuxsoloOfficial)!
...
""",
	"help_text": """
Hey there! My name is *linuxsolo*.
...
# Backups
	...
	"Telah terjadi kesalahan dalam import backup linuxsolo!\nGabung ke [Grup support](https://t.me/linuxsoloOfficial) kami untuk melaporkan dan mengatasi masalah ini!\n\nTerima kasih": "An exception occured while restoring your data from linuxsolo backup!\nJoin our [Group support](https://t.me/linuxsoloOfficial) for reporting and troubleshooting this problem!\n\nThank you",
	...
	"backups_help": """
*Admin only:*
 - /import: reply to a group butler/marie/rose/linuxsolo backup file to import as much as possible, making the transfer super simple!
Note that files/photos from other bots can't be imported due to telegram restrictions. Except for linuxsolo backup it self.
