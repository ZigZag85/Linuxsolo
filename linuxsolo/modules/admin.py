...
from linuxsolo import dispatcher, updater, spamfilters
from linuxsolo.modules.disable import DisableAbleCommandHandler
from linuxsolo.modules.helper_funcs.chat_status import bot_admin, can_promote, user_admin, can_pin
...
from linuxsolo.modules.sql import admin_sql as sql
