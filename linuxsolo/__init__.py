...
if ENV:
	...
	from linuxsolo.config import Development as Config
...
from linuxsolo.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler
...
try:
	from linuxsolo.antispam import antispam_restrict_user, antispam_cek_user, detect_user
