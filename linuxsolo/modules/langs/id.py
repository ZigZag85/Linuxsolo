...
Gabung grup [linuxsolo Official Support](https://t.me/linuxsoloOfficial)!
...
""",
	"help_text": """
Hai! Nama saya adalah *linuxsolo*.
...
# Help modules
	"language_help": """Tidak semua grup berbicara bahasa Indonesia; beberapa grup lebih suka linuxsolo menanggapi dalam bahasa mereka sendiri.

Di sinilah terjemahan masuk; Anda dapat mengubah sebagian besar balasan linuxsolo menjadi bahasa pilihan Anda!
...
""",
	"backups_help": """
*Hanya admin:*
 - /import: balas ke file cadangan grup butler/marie/rose/linuxsolo untuk mengimpor sebanyak mungkin, membuat transfer menjadi sangat mudah! \
 Catatan bahwa file/foto tidak dapat diimpor karena pembatasan telegram. Kecuali backup dari linuxsolo.
...
RUN_STRINGS = (
    ...
    "Hei, lihat mereka! Mereka berlari dari linuxsolo yang tak terelakkan ... Lucu sekali 😂",
...
RAMALAN_STRINGS = (
	...
	"Anda akan mengalami kejadian aneh hari ini.\nDan itu tidak termasuk mendapatkan ramalan dari linuxsolo 😜",
	"Akhirnya ada kesempatan untuk beristirahat...\ndan mendengar ramalan dari linuxsolo 😉",
